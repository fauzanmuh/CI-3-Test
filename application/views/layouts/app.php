...
<html lang="en">
  ...
  <div class="container">
  <img src="https://www.codeigniter.com/favicon.ico" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
    <a class="navbar-brand" href="<?= base_url(); ?>">CI 3</a>
